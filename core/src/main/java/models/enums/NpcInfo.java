...
public enum NpcInfo {
    Sebastian(
            ...
            0, AssetManager.getSebastianTexture()
    ...
    NpcInfo(List<ItemType> favorites, HashMap<ItemType, Integer> requests, HashMap<ItemType, Integer> rewards, int friendshipIncrease,Texture texture) {
