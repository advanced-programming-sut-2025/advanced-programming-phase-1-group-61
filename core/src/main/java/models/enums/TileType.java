...
public enum TileType {
    ...
    BrokenGreenHouse(true , "3",new Texture("brokenGreenHouseFloor.png")),
    BrokenGreenHouseWall(true , "7",new Texture("brokenGreenHouseWall.png")),
    CabinFloor(false , "4",new Texture("CabinFloor.png")),
    CabinWall(true , "6",new Texture("cabinwall.png")),
