...
public enum NpcInfo {
    Sebastian(List.of(new Item(ItemType.Fur),new Item(ItemType.PumpkinPie),new Item(ItemType.Pizza)),
            ...
            new HashMap<>(Map.of(new Item(ItemType.Diamond),2,new Item(ItemType.Gold),5000,new Item(ItemType.Quartz),50))),
    Abigail(List.of(new Item(ItemType.Stone),new Item(ItemType.IronOre),new Item(ItemType.Coffee)),
            ...
            new HashMap<>(Map.of(new Item(ItemType.Gold),500,new Item(ItemType.WaterSprinkler),1))),
    Harvi(List.of(new Item(ItemType.Coffee),new Item(ItemType.Pickle),new Item(ItemType.Wine)),
            ...
            new HashMap<>(Map.of(new Item(ItemType.Gold),750,new Item(ItemType.Salad),5))),
    Lia(List.of(new Item(ItemType.Salad),new Item(ItemType.Grape),new Item(ItemType.Wine)),
            ...
            new HashMap<>(Map.of(new Item(ItemType.Gold),500))),
    Robin(List.of(new Item(ItemType.Spaghetti),new Item(ItemType.Wood),new Item(ItemType.IronIngot)),
            ...
            new HashMap<>(Map.of(new Item(ItemType.Gold),1000,new Item(ItemType.BeeHouse),3,new Item(ItemType.Pony),25000)));
