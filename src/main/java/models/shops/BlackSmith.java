...
public class BlackSmith implements Mutual{
    ...
    private BlackSmith(){
        items=new ArrayList<>(List.of(
                new ShopItem(new Item(ItemType.CopperOre),Integer.MAX_VALUE,75),
                new ShopItem(new Item(ItemType.IronOre),Integer.MAX_VALUE,150),
                new ShopItem(new Item(ItemType.Coal),Integer.MAX_VALUE,150),
                new ShopItem(new Item(ItemType.GoldOre),Integer.MAX_VALUE,400)
        ));
